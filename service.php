                    ...
                    <div class="row align-items-center flex-row-reverse">
                        ...
                        <div class="col-xl-5 text-center text-xl-start">
                            <div class="title-area mb-35">
                                <span class="sub-title3"><img src="assets/img/theme-img/title_icon2.svg" alt="Icon">Takeaway Service</span>
                                <h2 class="sec-title">Authentic Indian Flavors, Ready for Pickup</h2>
                                <div class="text-ani">
                                    <p class="sec-text">Enjoy our delicious Indian cuisine in the comfort of your home. We offer quick and efficient takeaway services to ensure your food is ready when you are.</p>
                                </div>
                            </div>
