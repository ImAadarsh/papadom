...
==============================-->
            <div class="th-hero-wrapper hero-3" id="hero">
                                ...
                                <div class="hero-inner">
                                    ...
                                    <div class="container th-container">
                                        <div class="hero-style3">
                                            ...
                                            <a href="reservation.php" class="th-btn" data-ani="slideinup" data-ani-delay="0.7s">Order Now</a>
                                        </div>
                                    </div>
                                    <div class="hero-img">
                                        ...
                                        <div class="img1" data-ani="slideinright" data-ani-delay="0.1s">
                                            <img src="assets/img/hero/hero_3_1.png" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="hero-inner">
                                    ...
                                    <div class="hero-img">
                                        ...
                                        <div class="img1" data-ani="slideinright" data-ani-delay="0.1s">
                                            <img src="assets/img/hero/hero_3_3.png" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <a href="reservation.php" class="hero-btn">Book A Table</a>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="category-box">
                                        ...
                                        <h3 class="box-title"><a href="shop.php">Fried rice</a></h3>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="category-box">
                                        ...
                                        <h3 class="box-title"><a href="shop.php">Chicken Soup</a></h3>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="category-box">
                                        ...
                                        <h3 class="box-title"><a href="shop.php">Beef Noodles</a></h3>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="category-box">
                                        ...
                                        <h3 class="box-title"><a href="shop.php">Chicken Pasta</a></h3>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="category-box">
                                        ...
                                        <h3 class="box-title"><a href="shop.php">Shrimp Soup</a></h3>
                                    </div>
                                </div>
                    ...
                    <div class="row gy-30 justify-content-center">
                        <div class="col-lg-6">
                            <div class="cta-card" data-bg-src="assets/img/bg/cta_bg_21.jpg">
                                ...
                                <h4 class="box-heading title-ani2">HUM BURGER</h4>
                        ...
                        <div class="col-lg-6">
                            <div class="cta-card" data-bg-src="assets/img/bg/cta_bg_22.jpg">
                                ...
                                <h3 class="box-title title-ani2">Delicious</h3>
                                <h4 class="box-heading title-ani2">Italian Pizza</h4>
                                <h4 class="box-text title-ani2">Limited Offer</h4>
                                <div class="text-ani">
                                    <a href="shop-details.php" class="th-btn btn-sm style3">Order Now</a>
                                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-5 text-center text-xl-start">
                            <div class="title-area mb-35">
                                <span class="sub-title3"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">About Our Food</span>
                                <h2 class="sec-title">The Fine Art of Restar's Food Services</h2>
                                <div class="text-ani">
                            ...
                            <div class="about-feature-wrap">
                                <div class="about-feature text-ani">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="box-text">The carefully curated décor sets the stage.</p>
                                    </div>
                                </div>
                                <div class="about-feature text-ani">
                                    <div class="box-icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="box-text">Define the concept and theme of your food.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="text-ani">
                                <a href="about.php" class="th-btn style-border">Book A Table</a>
                            </div>
                        </div>
                    </div>
                </div>
...
Feature Area  
==============================-->
            <section class="feature-sec1" data-bg-src="assets/img/bg/feature_bg_1.jpg">
                <div class="container">
...
==============================-->
            <section class="space" id="shop-sec">
                <div class="shape-mockup spin d-none d-lg-block" data-top="8%" data-left="3%"><img class="gspin" src="assets/img/shape/flower_9.png" alt="shape"></div>
                <div class="shape-mockup jump-reverse" data-bottom="8%" data-right="0"><img src="assets/img/shape/flower_6.png" alt="shape" data-speed="1.2"></div>
                <div class="container text-center">
                    <div class="title-area text-center">
                        <span class="sub-title3"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">Our Menu</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Egg and Cocumber</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat1 cat2">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Tofu Red Chili</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat1 cat3">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Salmon Salad</a></h3>
                                    <span class="price">$24.00<del>$32.00</del></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Raw Salmon Salad</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Salmon Beef Stack</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat1 cat2">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Chicken Fride Rice</a></h3>
                                    <span class="price">$30.85</span>
                                </div>
                            </div>
                        </div>

                        <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2 cat1">
                            <div class="th-product product-grid">
                                <div class="product-img transparent-img">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Sicilian Pizza</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Chicken with Rice</a></h3>
                                    <span class="price">$30.85</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row flex-row-reverse align-items-center">
                        <div class="col-lg-6">
                            <div class="cta-img1">
                                ...
                                <h4 class="price" data-bg-src="assets/img/bg/shape_bg_2.svg">$60</h4>
                            </div>
                        </div>
            ...
            <div class="overflow-hidden space">
                <div class="container">
                    <div class="row align-items-center flex-row-reverse">
                        ...
                        <div class="col-xl-5 text-center text-xl-start">
                            <div class="title-area mb-35">
                                <span class="sub-title3"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">Food Delivery</span>
...
Menu Area  
==============================-->
            <section class="menu-sec4 space" data-bg-src="assets/img/bg/menu_bg_4.png">
                <div class="container">
                    <div class="title-area text-center">
                        <span class="sub-title3"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">Our Menu</span>
                    ...
                    <div class="row offer-box-row">
                        <div class="col-xl-4 col-md-6">
                            <div class="offer-box mega-hover" data-bg-src="assets/img/bg/cta_bg_41.jpg">
                                <h3 class="box-title title-ani2">BURGER</h3>
                                <p class="box-text title-ani2">Get a 20% Discount On This Week</p>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="offer-box mega-hover" data-bg-src="assets/img/bg/cta_bg_42.jpg">
                                <h3 class="box-title title-ani2">FRENCH FRY</h3>
                                <p class="box-text title-ani2">Get a 20% Discount On This Week</p>
                                <a href="shop-details.php" class="line-btn title-ani2">Order Now</a>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="offer-box mega-hover" data-bg-src="assets/img/bg/cta_bg_43.jpg">
                                <h3 class="box-title title-ani2">ITALIAN PASTA</h3>
                                <p class="box-text title-ani2">Get a 20% Discount On This Week</p>
                                <a href="shop-details.php" class="line-btn title-ani2">Order Now</a>
                            </div>
                        </div>
...
==============================-->
            <div class="bg-white">
                <div class="shape-mockup jump d-none d-xl-block" data-top="7%" data-right="0"><img src="assets/img/shape/tomato_1.png" alt="shape" data-speed="1.1"></div>
                <div class="shape-mockup moving d-none d-xl-block" data-bottom="0" data-right="0"><img src="assets/img/shape/red_cilli.png" alt="shape"></div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-7">
...
==============================-->
            <section class="space-bottom" id="blog-sec">
                <div class="container">
                    <div class="title-area text-center">
                        <span class="sub-title3"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">News & Blog</span>
                            ...
                            <div class="col-md-6 col-xl-auto">
                                <div class="widget widget_download footer-widget">
                                    ...
                                    <div class="th-download-widget">
                                        ...
                                        <div class="btn-group">
                                            <a href="https://www.apple.com/app-store/" class="download-btn">
                                                <img src="assets/img/icon/app_store_1.png" alt="icon">
                                            </a>
                                            <a href="https://play.google.com/store/apps" class="download-btn">
                                                <img src="assets/img/icon/app_store_2.png" alt="icon">
                                            </a>
                                        </div>
                                        <p class="mt-30 mb-3">24/7 Support Center</p>
                                        <h3 class="box-title"><a href="tel:+19524357106">+1 952-435-7106</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
